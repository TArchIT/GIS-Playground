...
<qgis version="2.18.11" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{0dce21b2-9579-41b6-9025-b13e858c60b8}">
      <rule scalemaxdenom="50000" filter="&quot;fclass&quot; = 'canal'" key="{75c816d5-f33b-4509-bdb7-5bdada4ba848}" symbol="0" scalemindenom="1000" label="canal"/>
      <rule scalemaxdenom="50000" filter="&quot;fclass&quot; = 'drain'" key="{cb2ae17d-2498-405b-887a-1b4e88459399}" symbol="1" scalemindenom="1000" label="drain"/>
      <rule scalemaxdenom="1000000" filter="&quot;fclass&quot; = 'river'" key="{c1c16c89-2bdb-46eb-b71d-18ef3c8973ae}" symbol="2" scalemindenom="1000" label="river"/>
      <rule scalemaxdenom="75000" filter="&quot;fclass&quot; = 'stream'" key="{a3159247-9469-4761-8323-7e4e15099447}" symbol="3" scalemindenom="1000" label="stream"/>
      <rule filter="ELSE" key="{95ea2430-b835-45e1-bf91-5d1a678bbf8c}" symbol="4"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.290196" clip_to_extent="1" type="line" name="1">
        ...
        <layer pass="0" class="SimpleLine" locked="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="126,63,0,255"/>
      ...
      <symbol alpha="0.223529" clip_to_extent="1" type="line" name="3">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="round"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="237,87,68,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
